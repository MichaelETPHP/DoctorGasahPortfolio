...
<section id="about" class="section bg-white">
  <div class="container-custom">
    <div class="text-center mb-12">
      <h2 class="section-title">About Dr. Gashaw A</h2>
    ...
    <div class="flex flex-col md:flex-row gap-10 items-center">
      ...
      <div class="md:w-1/2 transition-all duration-1000 delay-300" class:translate-x-0={visible} class:translate-x-16={!visible} class:opacity-100={visible} class:opacity-0={!visible}>
        ...
        <p class="mb-6 text-gray-700">
          Dr. Gashaw A is a distinguished pediatric hematology oncologist specializing in childhood blood cancers and neuroblastoma. With years of dedicated training and clinical practice, he has established himself as a leading expert in Ethiopia's medical community.
        </p>
        <p class="mb-6 text-gray-700">
          Dr. Gashaw divides his time between Black Lion Hospital, where he serves as a senior consultant, and Betzata Private Clinic, where he provides specialized care in a private setting. His dual role allows him to serve patients across different socioeconomic backgrounds.
        </p>
