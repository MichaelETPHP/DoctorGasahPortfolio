import { h as head, p as push, e as attr_class, c as pop, i as ensure_array_like, j as attr_style, k as attr, f as escape_html, l as stringify } from './index2-CuTCCia1.js';

function Hero($$payload, $$props) {
  push();
  let ready = false;
  $$payload.out += `<section id="home" class="relative min-h-screen flex items-center bg-gradient-to-r from-blue-900 to-blue-700 text-white svelte-1x1u2ax"><div class="absolute inset-0 bg-blue-900 opacity-80 svelte-1x1u2ax"></div> <div class="container-custom relative z-10 flex flex-col-reverse md:flex-row items-center svelte-1x1u2ax"><div${attr_class("md:w-1/2 pt-8 md:pt-0 md:pr-10 animate-fade-in-up svelte-1x1u2ax", void 0, { "opacity-0": true, "opacity-100": ready })}><h1 class="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight svelte-1x1u2ax">Dr. Gasah A</h1> <h2 class="text-2xl md:text-3xl font-medium text-blue-200 mb-6 svelte-1x1u2ax">Pediatric Hematology Oncologist</h2> <p class="text-lg md:text-xl mb-8 text-blue-100 max-w-xl svelte-1x1u2ax">Dedicated to advancing care and research in pediatric blood cancers and neuroblastoma in Ethiopia.</p> <div class="flex flex-wrap gap-4 svelte-1x1u2ax"><a href="#contact" class="btn btn-primary bg-white text-blue-900 hover:bg-blue-50 svelte-1x1u2ax">Book Appointment</a> <a href="#about" class="btn btn-outline border-white text-white hover:bg-blue-800 svelte-1x1u2ax">Learn More</a></div></div> <div class="md:w-1/2 flex justify-center svelte-1x1u2ax"><div${attr_class("w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-white shadow-lg transform transition-all duration-700 hover:scale-105 svelte-1x1u2ax", void 0, { "opacity-0": true, "opacity-100": ready })}><img src="/images/dr-gasah-profile.jpg" alt="Dr. Gasah A, Pediatric Hematology Oncologist" class="w-full h-full object-cover svelte-1x1u2ax"></div></div></div> <div class="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce svelte-1x1u2ax"><a href="#about" class="text-white svelte-1x1u2ax" aria-label="Scroll to About section"><svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 svelte-1x1u2ax" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 14l-7 7m0 0l-7-7m7 7V3" class="svelte-1x1u2ax"></path></svg></a></div></section>`;
  pop();
}
function About($$payload, $$props) {
  push();
  let visible = false;
  $$payload.out += `<section id="about" class="section bg-white"><div class="container-custom"><div class="text-center mb-12"><h2 class="section-title">About Dr. Gasah A</h2> <p class="section-subtitle mx-auto">Dedicated to improving children's lives through specialized care and groundbreaking research</p></div> <div class="flex flex-col md:flex-row gap-10 items-center"><div${attr_class("md:w-1/2 transition-all duration-1000 svelte-1rphvr1", void 0, {
    "translate-x-0": visible,
    "-translate-x-16": true,
    "opacity-100": visible,
    "opacity-0": true
  })}><div class="relative rounded-xl overflow-hidden shadow-xl"><img src="/doctor-profile.jpg" alt="Dr. Gasah A in a clinical setting" class="w-full h-auto"> <div class="absolute inset-0 bg-gradient-to-t from-blue-900 to-transparent opacity-80"></div> <div class="absolute bottom-0 p-6 text-white"><h3 class="text-2xl font-bold">Dr. Gasah A</h3> <p class="text-blue-100">Pediatric Hematology Oncologist</p></div></div></div> <div${attr_class("md:w-1/2 transition-all duration-1000 delay-300 svelte-1rphvr1", void 0, {
    "translate-x-0": visible,
    "translate-x-16": true,
    "opacity-100": visible,
    "opacity-0": true
...
//# sourceMappingURL=_page.svelte-rh2gVy48.js.map
